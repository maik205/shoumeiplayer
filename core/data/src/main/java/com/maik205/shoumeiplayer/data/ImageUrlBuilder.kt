...
class ImageUrlBuilder(
    ...
    /**
     * Keeps the common one-provider construction unambiguous. Without this overload, Kotlin binds
     * a trailing lambda to [accessTokenProvider] and reports the first function parameter missing.
     */
    constructor(serverUrlProvider: () -> String?) : this(serverUrlProvider, { null })
