 ...
 * function of the normalized [TrickplayInfo] manifest the item query returned.
 */
object TrickplayMath {
     ...
     */
    fun tileAt(info: TrickplayInfo, positionMs: Long): TrickplayTile? {
     ...
     */
    fun selectBand(bands: Map<String, TrickplayInfo>, targetWidth: Int): TrickplayInfo? {
...
object TrickplayUrl {
     ...
     * ([TrickplayInfo.width], which is also the key of its band in the manifest map) — not the
